...
/* 7 */
SELECT E.EMP_NAME "EMPLOYEE",E.EMP_NO "EMP", EM.MNG_ "NAME" 
FROM "MANAGER", EM.MNG_NO "MGR", FROM EMPLOYEE E 
EMPLOYEE_MANAGER EM WHERE E.EMP_NO=EM.EMP_NO; 

/* 8 */
SELECT E.EMP_NAME, EM.EMP_HIREDATE FROM EMPLOYEE 
E,EMPLOYEE_MANAGER EM WHERE E.EMP_NO =EM.EMP_NO AND EM. 
EMP_ HIREDATE > (SELECT EMP_HIREDATE FROM EMPLOYEE _MANAG 
ER WHERE EMP_NAME=’SCOTT’ ; 
